...
tableList = addEmptyLines(tableList)
...
print("----- Total :", sum, "-----")
# Convert the text into a matrix, add all required columns and lines, then get all coordinates in that matrix and calculate the distance between each points
